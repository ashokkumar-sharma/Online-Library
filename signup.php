...
//                    mail($getemail, $subject, $message, $headers);
                     echo "<span style='color: #fff; font-size: 20px; padding-top: 30px;'>You've been registered.<a href='login.php' style='color: #fff; text-decoration: none;'>Click here to go to login page.</a></span>";
                     $getuser = "";
                     $getemail = "";
                 }
                 else
