...
//                    echo "$password";
                    ...
                    if($numrows == 1){
                        ...
                        if($password == $dbpass){
                            ...
                            echo "<span style='color: white; font-size: 25px;'>You have been logged in as <b>$dbuser</b>! <a href='redirect/index.php' style='color: white; text-decoration: none;'>CLICK HERE</a> to go to Main Page</span>";
                            $status = 1;
                            $_SESSION['status'] = 1;
                        }
                        else{
                            $status = 0;
                            $_SESSION['status'] = 0;
                            echo "<span style='color: #ffffff;'>Invalid Password.</span>";
                            echo "$form";
                        }
                    }
                    else
