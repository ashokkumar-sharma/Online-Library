...
<body data-speed="10" data-type="background">
    ...
    <script>
        ...
        $('div[data-type="background"]').each(function () {
            ...
            function change_div(){
                $('#div1').load('includes/ebook/thriller.html');        
            }
        function change_div1(){
                $('#div1').load('includes/ebook/history.html');        
            }
        function change_div2(){
                $('#div1').load('includes/ebook/comics.html');        
            }
        function change_div3(){
                $('#div1').load('includes/ebook/biography.html');        
            }
        function change_div4(){
                $('#div1').load('includes/ebook/romance.html');        
        }
