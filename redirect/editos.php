...
<script src="js/team.js"></script>
    <script>
        ...
        function change_div(){
                $('#div1').load('includes/editor/thriller.html');        
            }
        function change_div1(){
                $('#div1').load('includes/editor/history.html');        
            }
        function change_div2(){
                $('#div1').load('includes/editor/comics.html');        
            }
        function change_div3(){
                $('#div1').load('includes/editor/biography.html');        
            }
        function change_div4(){
                $('#div1').load('includes/editor/romance.html');        
            }
    </script>
</body>
</html>