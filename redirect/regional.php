...
<script src="js/team.js"></script>
    <script>
        ...
        function change_div(){
                $('#div1').load('includes/regional/hindi.html');        
            }
        function change_div1(){
                $('#div1').load('includes/regional/tamil.html');        
            }
        function change_div2(){
                $('#div1').load('includes/regional/marathi.html');        
            }
        function change_div3(){
                $('#div1').load('includes/regional/gujrati.html');        
            }
        function change_div4(){
                $('#div1').load('includes/regional/bengali.html');        
            }
    </script>
</body>
</html>