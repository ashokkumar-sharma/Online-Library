...
<script src="js/team.js"></script>
    <script>
        ...
        function change_div(){
                $('#div1').load('includes/videos/educational.html');        
            }
        function change_div1(){
                $('#div1').load('includes/videos/technology.html');        
            }
        function change_div2(){
                $('#div1').load('includes/videos/fitness.html');        
            }
        function change_div3(){
                $('#div1').load('includes/videos/motivational.html');        
            }
        function change_div4(){
                $('#div1').load('includes/videos/docu.html');        
            }
    </script>
</body>
</html>