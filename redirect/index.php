    ...
    <div id="content">
            ...
            <nav class="nav">
                ...
                <table>
                    <tr>
                        ...
                        <td class="portal"><a href="#"><?php echo "$username" ?></a></td>
        ...
        <section id="sec1">
               ...
               <div class="sec">
                <ul class="no1">
                    <li class="cat-1">
                    <a href="ebook.php"><img src="assets/eBook1.png"></a>
                    </li>
                    <li class="cat-2"><a href="mag.php"><img src="assets/magazine.png"></a></li>
                    <li class="cat-3"><a href="videos.php"><img src="assets/Videos.png"></a></li>
                </ul>
                <br>
                <br>
                <ul class="no2">
                    <li class="cat-4"><a href="articles.php"><img src="assets/article.png"></a></li>
                    <li class="cat-5"><a href="regional.php"><img src="assets/regional.png"></a></li>
                    <li class="cat-6"><a href="editos.php"><img src="assets/editor.png"></a></li>
                </ul>
