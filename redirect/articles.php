...
<script src="js/team.js"></script>
    <script>
        ...
        function change_div(){
                $('#div1').load('includes/articles/trending.html');        
            }
        function change_div1(){
                $('#div1').load('includes/articles/facts.html');        
            }
        function change_div2(){
                $('#div1').load('includes/articles/top10.html');        
            }
        function change_div3(){
                $('#div1').load('includes/articles/author.html');        
            }
        function change_div4(){
                $('#div1').load('includes/articles/astrology.html');        
            }
    </script>
</body>
</html>